    ...
    >
      <div className="absolute inset-0 -z-10">
        <Image
          ...
          alt="Glowing digital globe surrounded by icons for code, mobile, cloud, security, analytics, and support, representing Bahu Technology's web development services"
          fill

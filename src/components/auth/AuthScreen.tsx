          ...
          >
            ...
            <div key={mode} className="auth-fade-in relative mx-auto max-w-sm text-center">
              ...
              <h2 className="mt-6 font-display text-2xl font-semibold text-ink">
                {mode === "signup" ? "Join Bahu Technology" : mode === "forgot" ? "Forgot your password?" : "Welcome Back"}
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-muted">
                {mode === "signup"
                  ...
                  : mode === "forgot"
                    ...
                    : "Sign in to view your orders, track projects, and stay connected with Bahu Technology."}
              </p>
                ...
                {mode !== "forgot" ? (
                  <>
                    ...
                    <p className="mt-8 text-center text-sm text-muted">
                      {mode === "signin" ? "New to Bahu Technology?" : "Already have an account?"}{" "}
                      <button
                        type="button"

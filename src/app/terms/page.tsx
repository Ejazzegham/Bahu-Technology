...
export const metadata: Metadata = {
  title: "Terms of Service — Bahu Technology",
  description:
    "Read the Terms of Service governing your use of the Bahu Technology website and our graphic design, web, mobile, and custom software services.",
  alternates: { canonical: "/terms" },
};

const SECTIONS: LegalSection[] = [
  {
    heading: "About Bahu Technology",
    blocks: [
      { type: "p", text: "Bahu Technology provides professional digital services, including but not limited to:" },
      {
        type: "ul",
        items: [
          "Graphic Design",
    ...
    blocks: [
      { type: "p", text: "Unless otherwise agreed in writing:" },
      {
        ...
        items: [
          ...
          "Bahu Technology retains ownership of any pre-existing tools, frameworks, templates, libraries, or reusable code used during development.",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Bahu Technology reserves the right to refuse projects that conflict with our policies or applicable law.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "To the fullest extent permitted by law, Bahu Technology is not liable for indirect, incidental, special, or consequential damages, including loss of profits, data, or business opportunities arising from the use of our services.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      { type: "p", text: "Bahu Technology may update these Terms of Service from time to time." },
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "These Terms are governed by the laws applicable in the jurisdiction where Bahu Technology operates, unless another governing law is agreed in writing or required by applicable law.",
      },
    ],
  },
  {
    ...
    blocks: [
      { type: "p", text: "If you have questions regarding these Terms of Service, please contact us." },
      {
        ...
        items: [
          ...
          <>
            Website:{" "}
            <a href="https://bahutechnology.com" className="text-gold hover:underline">
              bahutechnology.com
            </a>
          </>,
        ],
        ...
        <section className="section">
          ...
          <div className="mt-12">
            <LegalContent
              ...
              intro={
                <>
                  Welcome to Bahu Technology. These Terms of Service (&ldquo;Terms&rdquo;) govern your use of our
              ...
              closing={{
                ...
                text: (
                  <>
                    By using the Bahu Technology website or purchasing our services, you acknowledge that you have
                    read, understood, and agree to these Terms of Service.
                    <br />
                    <br />
                    <strong className="text-ink">Our Commitment</strong> — At Bahu Technology, we are committed to

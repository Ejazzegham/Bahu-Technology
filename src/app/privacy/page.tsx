...
export const metadata: Metadata = {
  title: "Privacy Policy — Bahu Technology",
  description:
    "Learn how Bahu Technology collects, uses, protects, and discloses your information when you visit our website or use our services.",
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "All project files, designs, source code, business information, and confidential documents shared with Bahu Technology remain strictly confidential.",
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", text: "Bahu Technology does not store your credit card or banking information on our servers." },
    ],
  },
  {
    ...
    blocks: [
      { type: "p", text: "Unless otherwise agreed in writing:" },
      {
        ...
        items: [
          ...
          "Bahu Technology retains the right to display completed work in our portfolio unless requested otherwise by the client.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    blocks: [
      { type: "p", text: "Bahu Technology may update this Privacy Policy at any time." },
        ...
        <section className="section">
          ...
          <div className="mt-12">
            <LegalContent
              ...
              intro={
                <>
                  Welcome to Bahu Technology. Your privacy is important to us. This Privacy Policy explains how we
              ...
              closing={{
                ...
                text: "At Bahu Technology, we value your trust and are committed to protecting your privacy. Whether you need Graphic Design, Website Development, Mobile App Development, or Custom Desktop Software, your information is handled with professionalism, confidentiality, and the highest standards of security.",
              }}
            />
          </div>
        </section>
